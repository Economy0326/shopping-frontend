...
| 구분 | 내용 |
| --- | --- |
| 프론트엔드 | 상품 탐색, 장바구니, 체크아웃, 회원/비회원 주문, 마이페이지, QnA/공지/FAQ 화면, 관리자 주문·반품·상품·공지·FAQ 화면 |
| 백엔드 연동 | JWT Access Token, Refresh Token Cookie, 주문/반품/상품/공지/QnA API 연동 |
| 제외 범위 | 외부 PG 결제 연동, 택배사 배송 API 연동 |
